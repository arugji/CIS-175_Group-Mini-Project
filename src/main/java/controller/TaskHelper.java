...
public class TaskHelper {
	private static final EntityManagerFactory tasksEMF = Persistence.createEntityManagerFactory("TasklistPlanner");
	...
	public List<Task> showAllTasks() {
		EntityManager tasksEM = tasksEMF.createEntityManager();
		tasksEM.getTransaction().begin();
		List<Task> tasks = (List<Task>) tasksEM.createQuery("SELECT t FROM Task t", Task.class).getResultList();
		tasksEM.close();
		return tasks;
	}
